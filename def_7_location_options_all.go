...
type paramsGenerateAllValidCombinations struct {
	...
	ResourcesNeededPerType   map[ResourceType]uint16
...
// Many per time interval.
func (loc *Location) GetAllSchedulingOptions(params *ParamsCanRun) (OptionsSchedule, error) {
